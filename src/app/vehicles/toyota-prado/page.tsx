...
export const metadata: Metadata = {
  title: 'Toyota Prado Parts & Accessories | Triomah Spares Ltd',
  description: 'Quality spare parts for Toyota Prado. Engine parts, filters, brakes, suspension, electrical components, and more. Expert support and fast delivery.',
}
...
const productCategories = [
  ...
  },
  {
    ...
    products: [
      ...
      {
        id: 6,
        name: 'Duralast Shock Absorbers (Front)',
        partNumber: 'SA789',
        sku: '345678',
        price: 'KSH 6,799',
        notes: 'Front Shock Absorbers',
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Toyota Prado</h1>
                <p className="text-sm text-gray-600">2010-2020 Toyota Land Cruiser Prado 2.7L DOHC 4cyl</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-sm">2010-2020 Toyota Land Cruiser Prado 2.7L DOHC 4cyl</span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold mb-6">Recommended For Your Toyota Prado</h2>
      ...
      <div className="bg-primary text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Our experts can help you find the perfect parts for your Toyota Prado
          </p>
